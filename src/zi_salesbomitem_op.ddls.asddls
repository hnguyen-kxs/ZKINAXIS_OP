...
@EndUserText.label: 'Basic View - Sales BOM Item'
...
@VDM.viewType: #BASIC
define view entity ZI_SalesBOMItem_OP
  as select from stko as _BOMHeader
    inner join   stas as _BOMSelection on  _BOMHeader.stlal = _BOMSelection.stlal
